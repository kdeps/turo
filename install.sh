...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for kdeps/turo

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/kdeps/turo/releases
...
get_binaries() {
  case "$PLATFORM" in
    darwin/amd64) BINARIES="turo" ;;
    darwin/arm64) BINARIES="turo" ;;
    linux/amd64) BINARIES="turo" ;;
    linux/arm64) BINARIES="turo" ;;
    windows/386) BINARIES="turo" ;;
    windows/amd64) BINARIES="turo" ;;
    *)
